...
export default {
    ...
    created() {
        this.getSjpadjusment() //LOAD DATA SJP KETIKA COMPONENT DI-LOAD
    },
    data() {
        return {
    ...
    computed: {
        ...
        page: {
            get() {
                return this.$store.state.sjpadjusment.page
            },
            set(val) {
                this.$store.commit('sjpadjusment/SET_PAGE', val)
            }
        }
    },
    watch: {
        page() {
            this.getSjpadjusment() //KETIKA VALUE PAGE TERJADI PERUBAHAN, MAKA REQUEST DATA BARU
        },
        search() {
            this.getSjpadjusment(this.search) //KETIKA VALUE SEARCH TERJADI PERUBAHAN, MAKA REQUEST DATA BARU
        }
    },
    methods: {
