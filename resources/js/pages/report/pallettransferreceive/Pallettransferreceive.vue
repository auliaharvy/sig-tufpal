...
export default {
    ...
    created() {
        this.getTransferPalletReceive() //LOAD DATA SJP KETIKA COMPONENT DI-LOAD
    },
    data() {
        return {
    ...
    computed: {
        ...
        page: {
            get() {
                return this.$store.state.pallettransferreceive.page
            },
            set(val) {
                this.$store.commit('pallettransferreceive/SET_PAGE', val)
            }
        }
    },
    watch: {
        page() {
            this.getTransferPalletReceive() //KETIKA VALUE PAGE TERJADI PERUBAHAN, MAKA REQUEST DATA BARU
        },
        search() {
            this.getTransferPalletReceive(this.search) //KETIKA VALUE SEARCH TERJADI PERUBAHAN, MAKA REQUEST DATA BARU
        }
    },
    methods: {
