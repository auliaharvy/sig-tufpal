<template>
    <div>
       ...
       <v-layout row wrap class="px-5">
            ...
            <v-flex class="px-5" xs12 md6 lg6>
                <div class="form-group" :class="{ 'has-error': errors.no_do }" :readonly="true">
        ...
        <v-layout row wrap class="px-5">
             <v-flex class="px-5" xs12 md6 lg6>
                <div class="form-group">
                    <label>Departure Pool Pallet</label>
                    <select class='form-control' v-model='sjp.departure_pool_pallet_id' :readonly="true">
            ...
            <v-flex class="px-5" xs12 md6 lg6>
                <div class="form-group">
                        ...
                        <select class='form-control' v-model='sjp.destination_pool_pallet_id' :readonly="true">
                            <option value='0' >Select Destination</option>
                            <option disabled v-for='data in pools.data' v-bind:key='data.destination_pool_pallet_id' :value='data.pool_pallet_id'>{{ data.pool_name }}</option>
                        </select>
                    </div>
            </v-flex>
        </v-layout>
        <v-layout row wrap class="px-5">
            <v-flex class="px-5" xs12 md6 lg6>
                <div class="form-group" :class="{ 'has-error': errors.reason }" >
                    ...
                    <input type="text" class="form-control" v-model="sjp.reason" >
