...
export default {
    name: 'DataRepairedpallet',
    created() {
        this.getRepairedpallet() //LOAD DATA SJP KETIKA COMPONENT DI-LOAD
    },
    data() {
        return {
    ...
    computed: {
        ...
        page: {
            get() {
                return this.$store.state.repairedpallet.page
            },
            set(val) {
                this.$store.commit('repairedpallet/SET_PAGE', val)
            }
        }
    },
    watch: {
        page() {
            this.getRepairedpallet() //KETIKA VALUE PAGE TERJADI PERUBAHAN, MAKA REQUEST DATA BARU
        },
        search() {
            this.getRepairedpallet(this.search) //KETIKA VALUE SEARCH TERJADI PERUBAHAN, MAKA REQUEST DATA BARU
        }
    },
    methods: {
