        ...
        <v-layout row wrap class="px-5">
            ...
            <v-flex class="px-5" xs6 md3 lg3>
                <div class="form-group" :class="{ 'has-error': errors.missing_pallet }">
                    <label for="">missing Pallet Pallet</label>
        ...
        <v-layout row wrap class="px-5">
            <v-flex class="px-5" xs12 md6 lg6>
                <div class="form-group" :class="{ 'has-error': errors.good_cement }">
                    ...
                    <input type="text" class="form-control" v-model="sjpstatus.good_cement" :readonly="true">
            ...
            <v-flex class="px-5" xs12 md6 lg6>
                <div class="form-group" :class="{ 'has-error': errors.good_cement }">
                    ...
                    <input type="text" class="form-control" v-model="sjpstatus.bad_cement" :readonly="true">
