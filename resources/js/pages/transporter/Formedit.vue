    ...
    <div>
       ...
       <!-- <div class="form-group" :class="{ 'has-error': errors.organization_id }">
        ...
        <!-- <div class="form-group">
            ...
            <select class='form-control' v-model='transporter.organization_id' :readonly="true">
                <option disabled v-for='data in organizations.data' v-bind:key='data.organization_id' :value='data.organization_id'>{{ data.organization_name }}</option>
            </select>
        </div> -->
