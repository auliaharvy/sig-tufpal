<template>
    <div>
        ...
        <!-- <div class="form-group" :class="{ 'has-error': errors.pool_pallet_id }">
            <label for="">Pool Pallet</label>
        ...
        <div class="form-group" :class="{ 'has-error': errors.good_pallet }" :readonly="true">
            ...
            <input type="text" class="form-control" v-model="newpallet.good_pallet" :readonly="true">
            <p class="text-danger" v-if="errors.good_pallet">{{ errors.good_pallet[0] }}</p>
        </div>
        <div class="form-group">
            <label>Pallet Vendor</label>
            <select class='form-control' v-model='newpallet.vendor' :readonly="true">
                <option disabled value="Pallet Vendor">Pallet Vendor</option>
            </select>
        </div>
        <div class="form-group" :class="{ 'has-error': errors.driver }" :readonly="true">
            <label for="">Driver</label>
            <input type="text" class="form-control" v-model="newpallet.driver" :readonly="true">
            <p class="text-danger" v-if="errors.driver">{{ errors.driver[0] }}</p>
        </div>
        <div class="form-group" :class="{ 'has-error': errors.vehicle }" :readonly="true">
            <label for="">Vehicle</label>
            <input type="text" class="form-control" v-model="newpallet.vehicle" :readonly="true">
